<div>
    <footer class="mt-auto w-full max-w-6xl hidden sm:block py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <!-- Grid -->
        <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-5">
            <div class="flex lg:flex-1 justify-center md:justify-start">
                <a href="/" class="-m-1.5 p-1.5 flex items-center gap-x-2">
                    <span class="sr-only">Portal ASN Ponorogo</span>
                    <img src="{{ asset('img/logo.png') }}" alt="Portal ASN Ponorogo" class="h-8 w-auto" />
            ...
            <!-- Social Brands -->
            <div class="md:text-end text-center space-x-2">
                <p class="text-gray-500 dark:text-neutral-500">
                    Dikembangkan <a
                        class="text-gray-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-gray-500"
                        href="https://kominfo.ponorogo.go.id">Dinas Kominfo dan Statistik Kabupaten Ponorogo</a>
                </p>
                <p class="text-gray-500 dark:text-neutral-500">
                    © {{ date('Y') }} Tim Pengembang A4 Bidang APTIKA.
                </p>
                {{-- <a
